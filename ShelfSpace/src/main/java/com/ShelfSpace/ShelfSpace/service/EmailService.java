...
public class EmailService {
	...
	public void sendSimpleMessage(MailBody mailBody) { // MailBody is a Record Who Takes The Data of Our Mail Body and
														// don't need any getter
														// and Setters For it bcz it already have it and its really good
														// of u want any
														// Immutable Object and it come in java 14

		SimpleMailMessage mailMessage = new SimpleMailMessage(); // A simple and straightforward class for creating
																	// basic email messages in Spring applications.
