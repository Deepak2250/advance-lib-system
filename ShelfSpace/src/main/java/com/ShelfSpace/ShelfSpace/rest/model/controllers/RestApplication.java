package com.ShelfSpace.ShelfSpace.rest.model.controllers;
...
import com.ShelfSpace.ShelfSpace.rest.model.service.StudentDetailsService;
...
public class RestApplication {
	...
	public ResponseEntity<?>addBooksToStudent(@RequestBody BooksDetails booksDetails ,@PathVariable Long roll_no){
		...
		return studentBook.map(studentBooks -> ResponseEntity.ok(studentBooks)).orElse(ResponseEntity.badRequest().build());
	}
